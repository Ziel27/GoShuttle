...
const DRIVER_WATCH_DISTANCE_INTERVAL_METERS = 50; // 50 meters
const DRIVER_CONTINUOUS_MIN_SYNC_INTERVAL_MS = 30_000; // 30 seconds
const DRIVER_CONTINUOUS_MIN_MOVE_METERS = 30; // 30 meters
